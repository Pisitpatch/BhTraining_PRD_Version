<%@ Page Title="" Language="VB" MasterPageFile="~/jci2013/JCIMasterPage.master" AutoEventWireup="false" CodeFile="report.aspx.vb" Inherits="jci2013_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin:5px 5px 5px 5px"> 
        <table width="100%" cellpadding="1" cellspacing="1">
            ...
            <tr><td width="100">Assessment</td>

                <td>
                    <asp:DropDownList ID="txtassessment" runat="server" DataTextField="name" DataValueField="assessment_id" AutoPostBack="True">
                    </asp:DropDownList>
                </td>
            </tr>

            <tr><td width="100" class="auto-style2">Link URL</td>

                <td class="auto-style2">
                    <asp:TextBox ID="txturl" runat="server" Width="500" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>

            <tr><td width="100" class="auto-style1"></td>

                <td class="auto-style1">
                    <input type="button" value="Compare JCI Standard Compliance Form by Percent" style="width:320px" onclick="window.open('report_compare.aspx?id=' + <% Response.Write(txtassessment.SelectedValue)%>)" />
            ...
            <tr><td width="100">&nbsp;</td>
                ...
                <td>
                     <input type="button" value="Compare JCI Standard Compliance Form by Chapter" style="width:320px" onclick="window.open('report_compare2.aspx?id=' + <% Response.Write(txtassessment.SelectedValue)%>)" />
       ...
       <table width="100%" cellpadding="1" cellspacing="1" border="0">
            <tr><td  style="text-align:center; height:500px;width:450px" valign="top">
                 <div id="chart2" style="margin-top:10px; margin-left:10px; width:450px;height:400px; "></div>
                </td>
