...
Partial Class game_evaluate_over
    ...
    Sub bindScore()
        ...
        Try
            ...
            For i As Integer = 0 To dsAll.Tables("tGroup").Rows.Count - 1
                sql = "SELECT * FROM jci_trans_list a INNER JOIN jci_master_group b ON a.game_group_id = b.group_id WHERE zone_no = " & dsAll.Tables("tGroup").Rows(i)("zone_no").ToString
                ...
                If CInt(dsAll.Tables("tGroup").Rows(i)("zone_no").ToString()) = (i + 1) Then
