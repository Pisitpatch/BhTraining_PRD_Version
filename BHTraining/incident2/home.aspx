...
<div id="header"><img src="../images/menu_01.png" width="32" height="32" hspace="5" align="absmiddle"  />&nbsp;&nbsp;Incident Report</div>
...
&nbsp;
      ...
      <tr>
        <td height="30">
          ...
          <asp:radiobutton ID="chk_showall" GroupName="mgr" runat="server" Text="Show incident report required response" /> 
          <asp:radiobutton ID="chk_relevant" GroupName="mgr" runat="server" Text="Show incident report related to the department"  /> 
           <asp:radiobutton ID="chk_reset" GroupName="mgr" runat="server" Text="Show all incident report" Checked  /> 
            </td>
      </tr>
      <tr>
