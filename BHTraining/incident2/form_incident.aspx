...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="100%" cellpadding="2" cellspacing="1">
          <tr>
            <td><img src="../images/menu_01.png" width="32" height="32" hspace="5"   />&nbsp;&nbsp;<span class="style1">Incident Report : 
    ...
    <asp:Button ID="cmdTQMDraft2" runat="server" Text="Save draft" OnCommand="onSave" 
            CommandArgument="" ForeColor="#FF3300" /> 
    <asp:Button ID="cmdTQMView2" runat="server" Text="Save revision"  ForeColor="#000099" Font-Bold="True" /> 
    <asp:Button ID="cmdTQMClose2" runat="server"  Text="Close incident" OnCommand="onSave" 
            CommandArgument="9" Font-Bold="True"  />
    <asp:Button ID="cmdDeptReturn2" runat="server"  Text="Save and return case to TQM" OnCommand="onSave" 
            CommandArgument="7" Font-Bold="True" OnClientClick="return confirm('Are you sure you want to return case to TQM?');"  />
...
<div class="remark" id="lblInform" runat="server">
  <img src="../images/sign_explain.png" alt="ir" width="16" height="16"  /> Send 
    report to TQM within 24 hours after occurrence (Sent to supervisor after office hour and immediately report if serious clinical occurence)
</div>
...
<div class="tabbertab">
  <h2>Incident Report Review log <asp:Label ID="lblReviewLogNum" runat="server" Text="(0)" /></h2>
               ...
               <legend><strong>Convert to Incident</strong></legend>
                ...
                <tr>
                    <td >
                        ...
                        &nbsp;ย้ายจาก Incident Report เป็น CFB Report
                        
                    &nbsp;</td>

                </tr>              
                <tr>
                    <td > <asp:Button ID="cmdCopyToCFB" runat="server" Text="Copy Incident to CFB Report" CausesValidation="False" Width="210px" OnClientClick="return confirm('Are you sure you want to copy to Incident Form ?');" />     Copy Incident Report เป็น CFB Report
                         &nbsp;</td>
                </tr>        
                <tr>
...
ErrorMessage="กรุณาระบุอายุเป็นตัวเลขเท่านั้น"  ValidationExpression="^\d+$" Display="Dynamic" ></asp:RegularExpressionValidator> 
  ...
  <tr>
    <td valign="top"> <span style="text-decoration: underline;"><asp:Label ID="lblIRdetail43" Text="Other" runat="server" /></span></td>
    <td>
...
<fieldset>
<a href="logbook.aspx" title="Log Book" >View TQM log book</a>
   <asp:Button ID="cmdPrintTQM" runat="server" Text="Print Part of TQM" 
                    CausesValidation="False" />
<br />
          <table width="100%" cellspacing="1" cellpadding="2">
    <tr>
          ...
          <tr>
              ...
              <td colspan="3">
                   <asp:DropDownList ID="txtcomboowner" runat="server" Width="305px" AutoPostBack="True">
                        ...
                        <asp:ListItem Value="Thanyaporn Khongphet">Thanyaporn Khongphet</asp:ListItem>
  ...
  <td  width="80"></td>
                      ...
                      <asp:Button ID="cmdTQMAddCause" runat="server" Text="Add Cause" />
                      <asp:Button ID="cmdTQMOrderCause" runat="server" Text="Save Order" />
                  </td>
              </tr>
    <tr>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td valign="top">
          <asp:Button ID="cmdAddPreventTQM" runat="server" Text="Add Action Plan" Width="110px" />
          <asp:Button ID="cmdAddPreventFromDept" runat="server" Text="Copy Action Plan from Mgr." Width="180px"  />
        </td>
    </tr>
              <tr>
                  <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <tr>
              ...
              <td>
                  ...
                  <asp:Button ID="cmdTQMAddDoctor" runat="server" Text="Add Involving Physician" />
              </td>
          </tr>
...
ErrorMessage="Please Enter Only Numbers"  ValidationExpression="^\d+$" ></asp:RegularExpressionValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;<asp:Button ID="cmdAddCFBNo" runat="server" Text="Add CFB No." />
                </td>
            </tr>
          </table>
       </td>
...
<br />
<fieldset>
  <legend><asp:Label ID="Label4" Text="Related Incident Report" runat="server" /></legend>
  <table width="100%" cellspacing="1" cellpadding="2">
    <tr>
      <td valign="top">
        <table width="100%" cellspacing="1" cellpadding="2">
...
ErrorMessage="Please Enter Only Numbers"  ValidationExpression="^\d+$" ></asp:RegularExpressionValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;<asp:Button ID="cmdAddIRNO" runat="server" Text="Add IR No." />
                </td>
            </tr>
...
<fieldset>
  <legend><asp:Label ID="Label7" Text="Repeat Incident Report" runat="server" /></legend>
  <table>
    <tr>
                <td width="100">
                    Report Type</td>
  ...
  <table width="100%" cellspacing="1" cellpadding="2">
    ...
    <tr>
      <td valign="top">
        ...
        <tr>
            <td valign="top">
                <asp:Button ID="cmdDeptAddCause" runat="server" Text="Add Cause" Width="110px" />
            </td>
        </tr>
         <tr>
    ...
    <tr>
      <td valign="top">
          <asp:Button ID="cmdAddPrevent" runat="server" Text="Add Action Plan" Width="110px" />
   ...
   <asp:Panel ID="panel_psm" runat="server" >
    ...
    <tr>
      ...
      <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                <fieldset><legend><strong>Risk Management Concern list</strong> </legend>
              <table  width="100%" cellpadding="2" cellspacing="1">
                 <tr>
                      <td  width="160" valign="top">
                          Concern</td>
                      <td valign="top">
                          <asp:Button ID="cmdPSMAddConcern" runat="server" Text="Add concern" />
                          &nbsp;</td>
                  </tr>
...
&nbsp;<img src="../images/spellcheck.png" width="16" height="16" /></td>
              ...
              <tr>
                ...
                <td valign="top">
                    <asp:DropDownList ID="txtpsm_add_dept" runat="server" DataTextField="dept_name_en" DataValueField="dept_id" Width="630px">
                                   ...
                                   &nbsp; &nbsp;&nbsp;
                    <asp:Button ID="cmdPSMAddDept" runat="server" Text="Add"  /> <asp:Button ID="cmdPSMRemoveDept" runat="server" Text="Delete"  />
              ...
              <tr>
                <td colspan="2" valign="top">
                 <asp:Button ID="cmdSaveConcenrn" runat="server" Text="Save" Font-Bold="True" />
                    &nbsp;<asp:Button ID="cmdCancelConcern" runat="server" Text="Cancel" />
               </td>
              </tr>
              <tr>
                <td colspan="2" valign="top"></td>
  ...
  <br />
    ...
    <asp:Button ID="cmdSubmit" runat="server"  Text="Submit" OnCommand="onSave" 
        ...
        <asp:Button ID="cmdTQMDraft1" runat="server" Text="Save draft" OnCommand="onSave" 
            CommandArgument="" ForeColor="#FF3300" /> 
       <asp:Button ID="cmdTQMView1" runat="server" Text="Save revision"  ForeColor="#000099" Font-Bold="True" /> 
