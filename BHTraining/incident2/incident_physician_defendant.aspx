...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div id="data">
            ...
            <td colspan="4"><table width="100%" cellpadding="2">
              <tr>
                ...
                <td width="385">
                    ...
                    <asp:ListItem Value="1">Incident Report Summary by Involving Physician</asp:ListItem>
                     <asp:ListItem Value="2">Incident Report Summary by Unit Defendant</asp:ListItem>
                     <asp:ListItem Value="4">Incident Report Summary by Relevant Unit</asp:ListItem>
                      <asp:ListItem Value="3">Incident Report Summary by Involving Physicain Specialty</asp:ListItem>
                    </asp:DropDownList>
             </td>
		...
		<table width="98%" cellpadding="3" cellspacing="0" class="tdata3">
		  <tr>
		    <td valign="top" class="statheader">Incident Report Summary by Involving Physician</td>
		    </tr>
		  <tr>
            ...
            <div class="statdesc">
              <table width="100%" cellpadding="0">
                <tr>
                  <td valign="top">Incident report information from&nbsp;
...
&nbsp;to
          ...
          <asp:panel ID="Panel_Unit" runat="server">
          	<table width="98%" cellpadding="3" cellspacing="0" class="tdata3">
		  <tr>
		    <td valign="top" class="statheader">Incident Report Summary by Unit Defendant </td>
		    </tr>
		  <tr>
		    <td valign="top" style="padding: 10px;">
            <div class="statdesc">
...
&nbsp;to
          ...
          <asp:panel ID="panel_specialty" runat="server">
          	<table width="98%" cellpadding="3" cellspacing="0" class="tdata3">
		  <tr>
		    <td valign="top" class="statheader">Incident Report Summary by Specialty </td>
		    </tr>
		  <tr>
		    <td valign="top" style="padding: 10px;">
            <div class="statdesc">
...
&nbsp;to
           ...
           <AlternatingRowStyle CssClass="row2" />
          	...
          	<table width="98%" cellpadding="3" cellspacing="0" class="tdata3">
		  <tr>
		    <td valign="top" class="statheader">Incident Report Summary by Relevant Unit </td>
		    </tr>
		  <tr>
		    <td valign="top" style="padding: 10px;">
            <div class="statdesc">
