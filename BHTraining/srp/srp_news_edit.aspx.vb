...
Partial Class srp_srp_news_edit
    ...
    Sub bindDetail()
        ...
        Try
            sql = "SELECT * FROM srp_news WHERE ISNULL(is_delete,0) = 0 AND new_id = " & id
            ...
            End If
            If ds.Tables("t1").Rows(0)("is_hot_new").ToString() = "1" Then
                chkNew.Checked = True
            Else
    ...
    Protected Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If mode = "add" Then
                pk = getPK("new_id", "srp_news", conn)
                sql = "INSERT INTO srp_news (new_id , title_th , detail_th , new_date , new_date_ts , create_by , create_date , is_active , is_hot_new , is_delete ) VALUES("
                sql &= "'" & pk & "' ,"
            ...
            If mode = "edit" Then
                sql = "UPDATE srp_news SET title_th ='" & addslashes(txttopic.Text) & "'"
                sql &= ", detail_th =  '" & (txtdetail.Text) & "'"
            ...
            If Not IsNothing(FileUpload0.PostedFile) Then
                ...
                If strFileName <> "" Then
                    ...
                    sql = "UPDATE srp_news SET file_name ='" & addslashes(strFileName) & "'"
    ...
    Protected Sub linkDeleteFile_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles linkDeleteFile.Click
        ...
        Try
            sql = "UPDATE srp_news SET file_name = null , file_path = null , file_size = null WHERE new_id = " & id
            errorMsg = conn.executeSQLForTransaction(sql)
            'Response.Write("pk = " & pk)
            If errorMsg <> "" Then
                Throw New Exception(errorMsg)
