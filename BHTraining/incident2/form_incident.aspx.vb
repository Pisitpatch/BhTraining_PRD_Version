    ...
    Partial Class incident_form_incident
        ...
        Protected Sub txtsubject_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtsubject.SelectedIndexChanged
            If txtsubject.SelectedValue <> "" Then
                ...
                If txtsubject.SelectedValue = "4" Then
                    template &= "Please find incident report. Please investigate on this matter, and kindly send it back to TQM." & vbCrLf & vbCrLf
                ...
                template &= "To access new online incident and customer feedback report, please open this link below. " & vbCrLf & " (http://bhportal)" & vbCrLf & "For more information please contact TQM department." & vbCrLf & vbCrLf
