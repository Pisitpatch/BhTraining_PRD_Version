...
Partial Class incident_logbook
    ...
    Sub bindDashboard()
        ...
        Try
            ...
            sql &= ", 'Incident report' AS 'Type of Report' ,'' AS 'Comment Type'  , 'IR' + CAST(b.ir_no AS varchar) AS 'Online Number' "
            ...
            sql &= ", ISNULL(case when b.clinical_type = 1 THEN 'Clinical' when b.clinical_type = 2 THEN 'Non-Clinical' END,'') AS 'Clinical type' "
            sql &= ", CASE WHEN b.severe_id = 1 THEN 'No Harm' WHEN b.severe_id = 2 THEN 'Mild Adverse Event' WHEN b.severe_id = 3 THEN 'Moderate Adverse Event' WHEN b.severe_id = 4 THEN 'Serious Adverse Event' WHEN b.severe_id = 5 THEN 'Sentinel event' WHEN b.severe_id = 10 THEN 'Near Miss' ELSE '-' END  AS 'Risk level'"
            ...
            sql &= " , b.location , b.describe AS Detail "
    ...
    Sub bindGrid()
        ...
        Try
            ...
            If reporttype <> "sup" Then
                ...
                sql &= ", '' AS ' root cause from IR' , c.action_detail AS 'action plan from IR ' , '' AS 'Response Unit 1' , '' AS 'Response Unit 2' "
                ...
                sql &= ", ISNULL(c.tqm_case_owner,'') AS 'IR Staff'  "
                ...
                sql &= ", case when c.is_refer = 1 then 'Yes' else 'No' end AS 'Refer to Risk Management' "
                ...
                sql &= " , replace(deptplan.action_plan,'&#x0D;',' , ') AS 'Action plan from unit', ISNULL(c.log_safety_goal2,'') AS 'Patient Safety Goals2', c.ir_related_standard AS 'Related Standard' "
            End If
    ...
    Protected Sub cmdSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSearch.Click
        ...
        ElseIf txtselect.SelectedValue = "7" Then
            bindMCO()
        ElseIf txtselect.SelectedValue = "8" Then
            bindDashboard()
        End If
