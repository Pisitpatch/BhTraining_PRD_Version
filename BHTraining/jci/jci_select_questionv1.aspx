...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tr>
    ...
    <strong>แบบประเมินกิจกรรม</strong><br />
    <asp:Panel ID="panel_eval" runat="server" BorderStyle="Solid" BorderWidth="1px">
    <table width="100%">
<tr>
<td width="50" style="vertical-align:top">1.</td>
...
<tr>
<td width="50" style="vertical-align:top">2.</td>
<td>
