<%@ Page Language="VB" AutoEventWireup="false" CodeFile="preview_tqm.aspx.vb" Inherits="cfb_preview_tqm" %>
...
<form id="form1" runat="server" enableviewstate="False" method="post">
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    ...
    <tr>
      <td>ผู้รายงานเหตุการณ์ <asp:label id="lblreport_by" runat="server"></asp:label> <asp:label id="lblreport_tel" runat="server"></asp:label> <asp:label id="lblreport_date" runat="server"></asp:label></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>ผู้สรุปเหตุการณ์ <asp:label id="lblOwner" runat="server"></asp:label> </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
