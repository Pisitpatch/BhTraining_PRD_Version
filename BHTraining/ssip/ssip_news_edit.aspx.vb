...
Partial Class ssip_ssip_news_edit
    ...
    Protected Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If mode = "add" Then
                pk = getPK("new_id", "ssip_news", conn)
                sql = "INSERT INTO ssip_news (new_id , title_th , detail_th , new_date , new_date_ts , create_by , create_date , is_active , is_delete ) VALUES("
                sql &= "'" & pk & "' ,"
            ...
            If mode = "edit" Then
                sql = "UPDATE ssip_news SET title_th ='" & addslashes(txttopic.Text) & "'"
            ...
            If Not IsNothing(FileUpload0.PostedFile) Then
                ...
                If strFileName <> "" Then
                    ...
                    sql = "UPDATE ssip_news SET file_name ='" & addslashes(strFileName) & "'"
                    ...
                    FileUpload0.PostedFile.SaveAs(Server.MapPath("../share/ssip/attach_file/" & new_filename & "." & extension))
                End If
    ...
    Protected Sub linkDeleteFile_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles linkDeleteFile.Click
        ...
        Try
            sql = "UPDATE ssip_news SET file_name = null , file_path = null , file_size = null WHERE new_id = " & id
            errorMsg = conn.executeSQLForTransaction(sql)
            'Response.Write("pk = " & pk)
            If errorMsg <> "" Then
                Throw New Exception(errorMsg)
