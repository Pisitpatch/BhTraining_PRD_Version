    ...
    <div>
      ...
      <tr><td  style="text-align:right" bgcolor="#eef1f3">
          ...
          <tr>
            ...
            <table width="100%" cellspacing="1" cellpadding="2" >
                <tr>
                  <td  valign="top" bgcolor="#eef1f3"><strong>Review</strong></td>
                  <td  valign="top" bgcolor="#eef1f3"><strong>By</strong></td>
                  <td  valign="top" bgcolor="#eef1f3"><strong>Position</strong></td>
                  <td  valign="top" bgcolor="#eef1f3"><strong>Unit/Dept</strong></td>
                  <td  bgcolor="#eef1f3"><strong>Date</strong></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#F8F8F8">
                      ...
                      <asp:Label ID="lblJobType" runat="server" 
                                      Text=""></asp:Label></td>
                  <td valign="top">
                      <asp:Label ID="txtname" runat="server" Text="Label"></asp:Label></td>
                  <td valign="top">
                    <asp:Label ID="txtjobtitle" runat="server" Text="Label"></asp:Label>
                </td>
                  <td valign="top"> <asp:Label ID="txtdeptname" runat="server" Text="Label"></asp:Label></td>
                  <td><asp:Label ID="txtdatetime" runat="server" Text="Label"></asp:Label></td>
                </tr>
              </table></td>
          </tr>
          <tr>
            ...
            <table width="90%">
                              <tr>
                        <td bgcolor="#eef1f3" width="200"><strong>Comment Subject</strong></td>
                        <td bgcolor="#eef1f3"><table width="100%" border="0">
                            <tr>
                              <td>
                                  <asp:TextBox ID="txtadd_subject" runat="server" Width="300px"></asp:TextBox>
                            </td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        ...
                        <td bgcolor="#eef1f3"><textarea name="txtcomment_detail" id="txtcomment_detail"  rows="5" style="width: 500px" runat="server"></textarea></td>
                      </tr>
            </table>
            </td>
          </tr>
...
ErrorMessage="Please Enter Only Numbers"  ValidationExpression="^\d+$" Display="Dynamic" ></asp:RegularExpressionValidator> 
                ...
                <tr>
                  ...
                  <td valign="top" ><textarea name="txtplan" id="txtplan" cols="45" rows="5" 
                          style="width: 750px" runat="server"></textarea></td>
                </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td valign="top"><textarea name="txtother" id="txtother" cols="45" rows="5" 
                    style="width: 785px" runat="server"></textarea></td>
          </tr>
