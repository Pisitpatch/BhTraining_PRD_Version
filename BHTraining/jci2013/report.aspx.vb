...
Partial Class jci2013_report
    ...
    Sub bindReport1()
        ...
        Try
            ...
            If txtassessment.SelectedIndex > 0 Then
                sql &= " AND a.assessment_id = " & txtassessment.SelectedValue
            End If
    ...
    Sub bindReport2() ' Stack Graph
        ...
        Try
            ...
            sql &= "  where  1 = 1 "
            If txtassessment.SelectedIndex > 0 Then
                sql &= " AND aa.assessment_id = " & txtassessment.SelectedValue
            End If
    ...
    Sub bindHeader(assessment_id As String)
        Dim sql As String = ""
        Dim ds As New DataSet

        Try
            sql = "select  CONVERT(VARCHAR(10),create_date_raw,103) AS create_date_raw  FROM jci13_assessment_list "
            sql &= " where 1 = 1 "
            ...
            '  Response.Write(global_submit_date)
        Catch ex As Exception
            Response.Write(ex.Message & sql)
        Finally
            ds.Dispose()
    ...
    Sub bindAssessment()
        ...
        Try
            sql = "SELECT assessment_id , (b.form_name + ', ' + assessment_date_str + ' ' + assessment_time_str + ' [' + emp_name + ', ' + location_name +']' ) AS name FROM jci13_assessment_list a  inner join jci13_form_list b on a.form_id = b.form_id "
            ...
            txtassessment.DataSource = ds
            txtassessment.DataBind()

            txtassessment.Items.Insert(0, New ListItem("-- All Assessment --", 0))
        Catch ex As Exception
            Response.Write(ex.Message & sql)
        Finally
            ds.Dispose()
    ...
    Protected Sub txtassessment_SelectedIndexChanged(sender As Object, e As EventArgs) Handles txtassessment.SelectedIndexChanged
        bindReport1()
        bindReport2()
        ...
        If txtassessment.SelectedIndex = 0 Then
            ...
            global_submit_date = ""
        Else
            bindHeader(txtassessment.SelectedValue)
            txturl.Text = "http://bhtraining/jci2013/report_snapshot.aspx?assessment_id=" & txtassessment.SelectedValue
        End If
