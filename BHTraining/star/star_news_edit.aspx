<%@ Page Language="VB" AutoEventWireup="false" CodeFile="star_news_edit.aspx.vb" Inherits="star_star_news_edit" ValidateRequest="false" %>
...
<body>
    ...
    <td  >รายละเอียด</td>
    <td  >
        <asp:TextBox ID="txtdetail" runat="server" Rows="5" Width="90%" TextMode="MultiLine" CssClass="tinymce"></asp:TextBox>
        </td>
    </tr>
    <tr>
    <td  >&nbsp;</td>
