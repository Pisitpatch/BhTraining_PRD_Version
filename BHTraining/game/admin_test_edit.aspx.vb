...
Partial Class game_admin_test_master
    ...
    Sub bindForm()
        ...
        Try
            ...
            txtcategory.SelectedValue = ds.Tables("t1").Rows(0)("category_id").ToString
            txttime.Text = ds.Tables("t1").Rows(0)("time_amount_sec").ToString
    ...
    Protected Sub cmdCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdCancel.Click
        Response.Redirect("admin_test_master.aspx")
    End Sub
    ...
    Protected Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            sql &= " , is_game = 1  "
            sql &= " , category_id = " & txtcategory.SelectedValue
            sql &= " , category_name = '" & txtcategory.SelectedItem.Text & "' "
            sql &= " , time_amount_sec = '" & txttime.Text & "' "
            ...
            sql &= " , create_by_dept_id = '" & Session("jci_dept_id").ToString & "' "
            sql &= " , create_by_dept_name = '" & Session("jci_dept_name").ToString & "' "
