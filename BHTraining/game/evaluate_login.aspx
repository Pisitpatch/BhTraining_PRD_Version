<%@ Page Language="VB" AutoEventWireup="false" CodeFile="evaluate_login.aspx.vb" Inherits="game_evaluate_login" %>
...
<form id="form1" runat="server" data-ajax="false">
		  <table width="100%">
		    <tr>
		      <td>&nbsp;&nbsp;</td>
		      <td align="right"><a href="multiple-choice-index.aspx"  data-enhance="false" data-role="none"><img src="images/home.png" width="32" height="32" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	        </tr>
	      </table>
	    </div><!-- /header -->
  ...
  <tr>
    <td height="615"><table width="100%" cellspacing="0" cellpadding="0">
  <tr>
