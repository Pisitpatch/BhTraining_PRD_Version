<%@ Page Title="" Language="VB" MasterPageFile="~/srp/SRP_MasterPage.master" AutoEventWireup="false" CodeFile="srp_report.aspx.vb" Inherits="srp_srp_report" %>
            ...
            <td colspan="4"><table width="100%" cellpadding="2">
              <tr>
                ...
                <td width="385">
                    ...
                    <asp:ListItem Value="1">1. สรุป จำนวนการ์ด OTS ที่นำมาลงทะเบียน</asp:ListItem>
                       <asp:ListItem Value="2">2. สรุป คะแนนที่ใช้ไปในแต่ละโครงการ</asp:ListItem>
                     <asp:ListItem Value="3">3. สรุป จำนวนการ์ดที่แลกและเงิน แยกตามแผนก</asp:ListItem>
                           <asp:ListItem Value="4">4. สรุป จำนวน CoAST แยกตามแผนก (จำนวนใบ X น้ำหนัก)</asp:ListItem>
                          <asp:ListItem Value="5">5. สรุป Point คงเหลือของพนักงาน</asp:ListItem>
                    </asp:DropDownList>
                  </td>
                <td width="80">&nbsp;</td>
                <td>
