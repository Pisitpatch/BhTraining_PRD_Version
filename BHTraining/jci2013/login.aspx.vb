...
Partial Class login
    ...
    Sub authenWithDatabase()
        ...
        Try
            ...
            sql &= " AND emp_code IN (SELECT jci_emp_code FROM jci13_user_authen WHERE is_admin = 1)"
            '   Response.Write(sql)
        ...
        Else
            ...
            Try
                If is_normal_user = 1 Then
                    ...
                    sql &= " AND a.emp_code IN (SELECT jci_emp_code FROM jci13_user_authen WHERE is_admin = 1)"
