<%@ Page Title="" Language="VB" MasterPageFile="~/incident/Incident_MasterPage.master" AutoEventWireup="false" Inherits="BHTraining.incident_report_viewer" Codebehind="report_viewer.aspx.vb" %>
...
<table width="100%" cellpadding="3">
  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td style="background: #366; color: #FFF; font-weight: bold; padding: 5px 8px; font-size: 14px;">Top 20 Accident & Incident Reports </td>
    </tr>
