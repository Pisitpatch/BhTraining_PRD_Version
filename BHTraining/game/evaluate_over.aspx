<%@ Page Language="VB" AutoEventWireup="false" CodeFile="evaluate_over.aspx.vb" Inherits="game_evaluate_over" %>
...
<div data-role="page" style="width: 1024px; height: 748px; background: url(images/GameJCI-1024x748-05.jpg) no-repeat;">

<div>
		  <table width="100%">
		    <tr>
		      <td height="60" style="font-family: 'Comic Sans MS'; font-size: 18px; font-weight: bold; color: #FFF;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		      <td width="285" align="right"  style="font-family: 'Comic Sans MS'; font-size: 18px; font-weight: bold; color: #FFF;"><a href="evaluate_login.aspx"   rel="external" ><img src="images/Logout.png"  border="0" style=" margin-top: 135px; margin-left: 55px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	        </tr>
  </table>
	    </div><!-- /header -->

	<div style="margin: 0px; padding: 0px; overflow: hidden;">
	  <div class="result" style="height: 415px; margin: 80px 120px" >
      <table width="100%">
  <tr>
    ...
    <div style="height: 300px; text-align: center; font-family: 'Comic Sans MS'; font-size: 18px; font-weight: bold; color: #FFF; line-height: 2.15em;"><br>
      ...
      <br>
ID   <%Response.Write(Session("jci_emp_code").ToString)%>
&nbsp;</div>
    </td>
    <td>
        ...
        <asp:Panel ID="panel1" runat="server">
          <table width="90%" cellspacing="0" cellpadding="8" style="margin: 0px 10px; font-family: 'Comic Sans MS'; font-size: 20px; font-weight: bold; color: #FFF; ">
            <tr>
              <td width="50%">Patient Safety </td>
              <td style="text-align: right; padding-right: 50px;">
                  <asp:Label ID="lblScore1" runat="server" Text="-"></asp:Label>
                </td>
              </tr>
            <tr>
              <td>Facility Mgt. and Safety</td>
              <td style="text-align: right; padding-right: 50px;"><asp:Label ID="lblScore2" 
                      runat="server" Text="-"></asp:Label></td>
              </tr>
            <tr>
              <td>Patient Care</td>
              <td style="text-align: right; padding-right: 50px;"><asp:Label ID="lblScore3" 
                      runat="server" Text="-"></asp:Label></td>
              </tr>
            <tr>
              <td>Healthcare Org.</td>
              <td style="text-align: right; padding-right: 50px;"><asp:Label ID="lblScore4" 
                      runat="server" Text="-"></asp:Label></td>
              </tr>
            <tr>
              <td>Result</td>
