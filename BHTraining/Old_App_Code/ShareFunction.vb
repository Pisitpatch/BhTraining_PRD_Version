...
Public Class ShareFunction
    ...
    Public Shared Function findArrayValue(ByVal tArray As Array, ByVal tValue As String) As Boolean
        ...
        Try
            For i As Integer = 0 To n - 1
                If tArray(i).ToString = tValue Then
                    Return True
                End If
            Next
    ...
    Public Shared Function isAccessToLinkClick() As Boolean
        ...
        Dim userPosition = HttpContext.Current.Session("user_position").ToString.ToLower
        Dim appSetting = ConfigurationManager.AppSettings()
        Dim authorizedAccessByCostcenterId = "authorizedAccessByCostcenterId"
        Dim authorizedAccessByJobType = "authorizedAccessByJobType"
        ...
        End If
        If appSetting.AllKeys.Contains(authorizedAccessByJobType) Then
            isAuthorizedAccess = isAuthorizedAccess Or appSetting(authorizedAccessByJobType).ToString().ToLower.Split(",").Contains(userPosition)
        End If
