             ...
             <tr>
                 ...
                 <td>  
				  <asp:DropDownList ID="txtpayor" runat="server">
					 <asp:ListItem Value="">------ Please Select ------</asp:ListItem>
					 <asp:ListItem Value="Contract company">Contract company</asp:ListItem>
					 <asp:ListItem Value="Embassy">Embassy</asp:ListItem>
					 <asp:ListItem Value="Government welfare">Government welfare</asp:ListItem>
					 <asp:ListItem Value="Insurance">Insurance</asp:ListItem>
					 <asp:ListItem Value="National Health Security">National Health Security</asp:ListItem>
					 <asp:ListItem Value="Self pay">Self pay</asp:ListItem>
					 <asp:ListItem Value="Social Security">Social Security</asp:ListItem>
					 <asp:ListItem Value="UCEP">UCEP</asp:ListItem>
         ...
         <tr>
                 ...
                 <td>
                     <asp:DropDownList ID="txtissue" runat="server">
						...
						<asp:ListItem Value="Add/Change Procedure">Add/Change Procedure</asp:ListItem>
						...
						<asp:ListItem Value="Incontinence">Incontinence</asp:ListItem>
						<asp:ListItem Value="Infiltrate/Phlebitis">Infiltrate/Phlebitis</asp:ListItem>
						...
						<asp:ListItem Value="Patients Identification">Patients Identification</asp:ListItem>
						<asp:ListItem Value="Pre-op Process">Pre-op Process</asp:ListItem>
						<asp:ListItem Value="Pressure Injury">Pressure Injury</asp:ListItem>
						<asp:ListItem Value="Prolonged Procedure">Prolonged Procedure</asp:ListItem>
						...
						<asp:ListItem Value="Skin Lesion">Skin Lesion</asp:ListItem>
          ...
          <tr>
              ...
              <td colspan="3">
                   <asp:DropDownList ID="txtcomboowner" runat="server" Width="305px" AutoPostBack="True">
						...
						<asp:ListItem Value="Naiyana Chailapakul">Naiyana Chailapakul</asp:ListItem>
						<asp:ListItem Value="Potjana Tantivit">Potjana Tantivit</asp:ListItem>
						<asp:ListItem Value="Sasithorn Sutinperk">Sasithorn Sutinperk</asp:ListItem> 
						<asp:ListItem Value="Weerasorn Anuchatwong">Weerasorn Anuchatwong</asp:ListItem>
					</asp:DropDownList><br />
