<%@ Page Title="" Language="VB" MasterPageFile="~/incident/Incident_MasterPage.master" AutoEventWireup="false" Inherits="BHTraining.incident.incident_form_incident" MaintainScrollPositionOnPostback="true" ValidateRequest="false" EnableEventValidation="false" Codebehind="form_incident.aspx.vb" %>
          ...
          <tr>
              ...
              <td colspan="3">
                   <asp:DropDownList ID="txtcomboowner" runat="server" Width="305px" AutoPostBack="True">
                                            ...
                                            <asp:ListItem Value="Wipamol Ruangsri">Wipamol Ruangsrik</asp:ListItem>
                                        </asp:DropDownList><br />
...
<ItemStyle Width="400px"></ItemStyle>
  ...
  <div class="tabber" id="mytabber11" style="height:100%">    
